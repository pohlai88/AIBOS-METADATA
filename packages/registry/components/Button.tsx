...
export function Button({
  ...
  const variantClasses = {
    primary: 'bg-primary text-white hover:bg-primary-hover focus-visible:ring-primary active:scale-[0.98]',
    secondary: 'bg-bg-muted text-fg border border-border hover:bg-bg-subtle focus-visible:ring-border active:scale-[0.98]',
    danger: 'bg-danger text-white hover:bg-danger/90 focus-visible:ring-danger active:scale-[0.98]',
    success: 'bg-success text-white hover:bg-success/90 focus-visible:ring-success active:scale-[0.98]',
  };
